...
Este livro surge como resposta à necessidade crescente de materiais que expliquem, com rigor técnico e linguagem acessível, **como a IA pode apoiar decisões, análises e estratégias na Ciência Animal**.
...
- sensores, automação e IoT;  
- visão computacional;  
- aprendizado profundo;  
- aplicações práticas em diferentes espécies e produtos;  
- desafios éticos e regulatórios.

Apêndices incluem análises complementares, como PCA e tabelas comparativas discutidas no livro.
...
Professor e pesquisador em Ciência da Computação, com foco em Inteligência Artificial, modelagem de dados, mineração de processos e sistemas explicáveis. Trabalha em projetos interdisciplinares envolvendo IA aplicada à saúde, indústria e ciência.
...
© Copyright – Ana Paula Ayub da Costa Barbon & Sylvio Barbon Junior  
